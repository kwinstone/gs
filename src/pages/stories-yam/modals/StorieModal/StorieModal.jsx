            ...
            <Col span={12}>
              <div className={styles.action}>
                <Button
                  ...
                  disabled={(editor?.media?.source || data?.Picture) ? false : true}
                />
              </div>
            </Col>
          </Row>
                    ...
                    <div 
                      ...
                      }
                      {
                        editor?.media?.type?.includes('image') && (
                            <img src={data?.PictureThumbnail || data?.Picture || editor?.media?.source} alt="" />
                        )
                      }
                      {
                        editor?.media?.type?.includes('video') && (
                          <video loop autoPlay src={data?.PictureThumbnail || data?.Picture || editor?.media?.source}/>
                        )
                      }
                    </div>
                  ) : (
