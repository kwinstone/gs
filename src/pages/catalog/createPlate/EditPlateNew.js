...
const EditPlateNew = () => {
    ...
    const nameTabs = [
        ...
        },
        {
            ...
            children: <Input
                ...
                placeholder={'Название блюда английском языке'}/>,
        },
    ];
    ...
    const editPlate = () => {
        ...
        }).finally(_ => setSaveLoad(false)).catch(err => message.error('Произошла ошибка'))
    }
    const deletePlate = () => {
        setDelLoad(true)
                                    ...
                                    isHideInOrg ? (
                                       ...
                                       
                                        {
                                            orgsList?.length == 0 ? (
                                                ...
                                                <div className="Modal__form_row">
                                                    <Pl onClick={openHideOrgModal} text={`Выбрано организаций ${orgsList?.length}`} style={{backgroundColor: '#fff', color: 'var(--violet)'}}/>
                                                </div>
                                            )
                                        }
                                        </>
